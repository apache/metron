...
public class GrokRFC3164Test {
	...
	private final String grokPath = "../metron-parsers/src/main/resources/patterns/rfc3164";
	private final String grokLabel = "RFC3164";
	...
	public void testParseRealLine() throws Exception {
		...
		GrokRFC3164Parser parser = new GrokRFC3164Parser(grokPath, grokLabel);
