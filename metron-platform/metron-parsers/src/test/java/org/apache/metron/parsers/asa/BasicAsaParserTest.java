...
public class BasicAsaParserTest {
    ...
    @Test
    public void testCISCOFW106023NoPrio() {
        String rawMessage = "Aug 05 2016 01:01:34: %ASA-4-106023: Deny tcp src Inside:10.30.9.121/54580 dst Outside:192.168.135.51/42028 by access-group \"Inside_access_in\" [0x962df600, 0x0]";
        JSONObject asaJson = asaParser.parse(rawMessage.getBytes()).get(0);

        System.out.println(asaJson);
        ...
        assertTrue(asaJson.get("ip_src_port").equals(54580));
        assertTrue(asaJson.get("ip_dst_port").equals(42028));
        assertTrue(asaJson.get("syslog_severity").equals("warn"));
        assertTrue((long) asaJson.get("timestamp") == 1470358894000L);
    }
