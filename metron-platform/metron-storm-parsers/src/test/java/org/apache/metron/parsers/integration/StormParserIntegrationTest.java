...
abstract class StormParserIntegrationTest extends ParserIntegrationTest {
  @Test
  public void test() throws Exception {
    String sensorType = getSensorType();
    ParserDriver driver = new StormParserDriver(sensorType, readSensorConfig(sensorType), readGlobalConfig());
    runTest(driver);
  }
}
