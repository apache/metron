...
//    HashMap<String, Object> globalConfig = new HashMap<>();
//    globalConfig.put(AsnDatabase.GEO_HDFS_FILE, asnHdfsFile.getAbsolutePath());
//    AsnDatabase.INSTANCE.updateIfNecessary(globalConfig);
//    Optional<HashMap<String, Object>> result = AsnDatabase.INSTANCE.get(IP_NO_DMA);
//    Assert.assertEquals("Remote Local IP should return result based on DB", expectedNoDmaMessage, result.get());
//
//    globalConfig.put(AsnDatabase.GEO_HDFS_FILE, geoHdfsFile_update.getAbsolutePath());
//    AsnDatabase.INSTANCE.updateIfNecessary(globalConfig);
//    result = AsnDatabase.INSTANCE.get(IP_NO_DMA);
//
//    Assert.assertEquals("Remote Local IP should return result based on DB", expectedNoDmaMessage, result.get());
//  }
}
