...
See more detail on starting parsers [here](https://github.com/apache/metron/blob/master/metron-platform/metron-parsers-common/README.md#starting-the-parser-topology)
...
From the usage docs, here are the options we've used. The full reference can be found [here](../metron-platform/metron-parsers-common/README.md#Starting_the_Parser_Topology).
