...
public class RegExFunctions {
  ...
  public static class RegexpGroupValue extends BaseStellarFunction {
    ...
    public Object apply(List<Object> list) {
      if(list.size() < 3) {
        throw new IllegalStateException("REGEXP_GROUP_VAL expects three args: [string, pattern, int] where pattern is a regexp pattern");
      }
      ...
      if(str == null || stringPattern == null || groupNumber == null) {
        return null;
      }
