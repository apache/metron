...
RESOURCE_LIST=(
    ...
    metron-platform/metron-parsers-common/parser_arch.png
...
HREF_REWRITE_LIST=(
    ...
    metron-platform/metron-parsers-common/README.md 's#(parser_arch.png)#(../../images/parser_arch.png)#g'
    metron-platform/metron-parsers-common/ParserChaining.md 's#(../../use-cases/parser_chaining/message_routing_high_level.svg)#(../../images/message_routing_high_level.svg)#g'
