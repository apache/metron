...
1.  Define your profiles.  In the editor, copy/paste the basic "Hello, World" profile below.
    ```
...
1. Create a message to simulate the type of telemetry that you expect to be profiled.   In the editor, copy/paste the JSON below.
    ```
...
1. After you are satisfied with the data being generated by the profile, then follow the [Getting Started](../metron-profiler#getting-started) guide to use the profile against your live, streaming data in a Metron cluster.