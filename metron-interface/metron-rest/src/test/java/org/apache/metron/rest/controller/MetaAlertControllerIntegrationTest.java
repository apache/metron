...
public class MetaAlertControllerIntegrationTest extends DaoControllerTest {
  ...
  public void test() throws Exception {
    ...
    ResultActions result =   this.mockMvc.perform(post(searchUrl + "/searchByAlert").with(httpBasic(user, password)).with(csrf()).contentType(MediaType.parseMediaType("application/json;charset=UTF-8")).content(findMessage0));
    try {
