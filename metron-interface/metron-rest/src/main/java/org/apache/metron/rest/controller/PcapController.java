...
public class PcapController {
  ...
  ResponseEntity<PcapResponse> query(@ApiParam(name="queryPcapRequest", value="A Fixed Pcap Request"
          + " which includes fixed filter fields like ip source address and protocol.", required=true)@RequestBody QueryPcapRequest queryPcapRequest) throws RestException {
    PcapResponse pcapsResponse = pcapQueryService.query(queryPcapRequest);
    return new ResponseEntity<>(pcapsResponse, HttpStatus.OK);
  }
}
