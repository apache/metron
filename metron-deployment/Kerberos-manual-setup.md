...
1. Deploy the [development environment.](vagrant/metron-on-centos/README.md).
...
1. Ensure that the KDC can issue renewable tickets. This may be necessary on a real cluster, but should not be on [Full Dev](vagrant/metron-on-centos/README.md).
