...
1. Change service directory names for Elasticsearch to the new desired version
    ...
    ```
    metron/metron-deployment/packaging/ambari/metron-mpack/src/main/resources/common-services/ELASTICSEARCH/5.6.13
    ```
...
1. Update metainfo.xml
    ...
    <osSpecifics>
        <osSpecific>
            ...
            <packages>
                <package>
                    <name>elasticsearch-5.6.13</name>
                </package>
            </packages>
        </osSpecific>
    </osSpecifics>
...
1. Change service directory names for Elasticsearch to the new desired version
    ...
    ```
    metron/metron-deployment/packaging/ambari/metron-mpack/src/main/resources/addon-services/ELASTICSEARCH/5.6.13
    ```
...
1. Update metainfo.xml
  ...
  Also make sure to update the "extends" version to point to the updated common-services version, e.g.
    ...
    <version>5.6.13</version>
    <extends>common-services/ELASTICSEARCH/5.6.13</extends>
    ```
...
1. Change service directory names for Kibana to the new desired version
    ...
    ```
    metron/metron-deployment/packaging/ambari/metron-mpack/src/main/resources/common-services/KIBANA/5.6.13
    ```
...
1. Change service directory names for Kibana to the new desired version
    ...
    ```
    metron/metron-deployment/packaging/ambari/metron-mpack/src/main/resources/addon-services/KIBANA/5.6.13
    ```
...
1. Update metainfo.xml
   ...
   Also make sure to update the "extends" version to point to the updated common-services version, e.g.
    ...
    <name>KIBANA</name>
    <version>5.6.13</version>
    <extends>common-services/KIBANA/5.6.13</extends>
    ```
