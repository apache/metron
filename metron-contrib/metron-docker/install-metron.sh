...
cp $METRON_PLATFORM_ROOT/metron-parsers-common/target/metron-parsers-common-$METRON_VERSION-archive.tar.gz $METRON_DOCKER_ROOT/storm/parser/
cp $METRON_PLATFORM_ROOT/metron-parsers-storm/target/metron-parsers-storm-$METRON_VERSION-archive.tar.gz $METRON_DOCKER_ROOT/storm/parser/
