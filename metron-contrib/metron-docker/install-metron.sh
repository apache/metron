...
cp $METRON_PLATFORM_ROOT/metron-parsers/metron-parsing-framework-storm/target/metron-parsing-framework-storm-$METRON_VERSION-archive.tar.gz $METRON_DOCKER_ROOT/storm/parser/
