...
ls -la $METRON_HOME/lib/
grep org/apache/metron/elasticsearch/dao/ElasticsearchDao $METRON_HOME/lib/*
ls -la $METRON_HOME/lib/metron-elasticsearch-$METRON_VERSION-uber.jar
echo $METRON_REST_CLASSPATH
