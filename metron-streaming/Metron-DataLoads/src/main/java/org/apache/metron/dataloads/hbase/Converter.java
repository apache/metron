...
public enum Converter {
    ...
    public Map.Entry<ExtractorResults, Long> fromPut(Put put, String columnFamily) throws IOException {
        ThreatIntelKey key = ThreatIntelKey.fromRow(put.getRow());
        ...
        return new AbstractMap.SimpleEntry<>(new ExtractorResults(key, value), lastSeen);
    }
    ...
    public Map.Entry<ExtractorResults, Long> fromResult(Result result, String columnFamily) throws IOException {
        ThreatIntelKey key = ThreatIntelKey.fromRow(result.getRow());
        byte[] cf = Bytes.toBytes(columnFamily);
        ...
        ExtractorResults results = new ExtractorResults(key, value);
