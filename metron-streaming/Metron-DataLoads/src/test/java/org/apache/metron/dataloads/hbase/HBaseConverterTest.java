...
public class HBaseConverterTest {
    ...
    public void testKeySerialization() {
        byte[] serialized = key.toRowKey();
        ThreatIntelKey deserialized = ThreatIntelKey.fromRow(serialized);
    ...
    public void testPut() throws IOException {
        ...
        Map.Entry<ExtractorResults, Long> converted= Converter.INSTANCE.fromPut(put, "cf");
    ...
    public void testResult() throws IOException {
        ...
        Map.Entry<ExtractorResults, Long> converted= Converter.INSTANCE.fromResult(r, "cf");
        Assert.assertEquals(new AbstractMap.SimpleEntry<>(results, timestamp), converted);
    }
    ...
    public void testGet() throws Exception {
        ...
        Assert.assertArrayEquals(key.toRowKey(), get.getRow());
    }
}
