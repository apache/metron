...
public class Bundle {
  ...
  /**
   * Constructor.
   * @param bundleDetails for the Bundle
   * @param classLoader for the Bundle
   */
  ...
  /**
   * Returns the BundleDetails for this Bundle.
   * @return the Bundle's BundleDetails
   */
   ...
   * @return the Bundle's ClassLoader
   */
